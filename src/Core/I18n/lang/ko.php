...
return [
    ...
    'diag.title' => '진단 결과',
    'diag.whySlow' => '느린 이유',
    'diag.otherFindings' => '기타 발견 사항',
    'diag.view' => '보기',
    'diag.empty' => '뚜렷한 병목을 찾지 못했습니다 (임계값: 자체 소요 시간 ≥ %s%%, 호출 횟수 ≥ %s, 에지 호출 횟수 ≥ %s, 피호출자 자체 소요 시간 ≥ %s%%, 메모리 피크 ≥ %s%%)',
    'diag.r1.title' => '%s 자체 소요 시간 %s, 이번 요청의 %s',
    'diag.r1.detail' => '자체 소요 시간은 자식 호출을 제외한 순수 함수 본문 비용입니다',
    'diag.r2.title' => '%s이(가) %s회 호출됨',
    'diag.r2.detail' => '호출 횟수가 많은 편입니다 — 예상한 동작인지 확인해 볼 필요가 있습니다',
    'diag.r3.title' => '%s → %s %s회 호출, 누적 %s',
    'diag.r3.detail' => '이 호출 에지가 상당한 비중의 시간을 차지합니다',
    'diag.r4.title' => '%s()에서 재귀가 감지되었습니다. 최대 깊이 %d',
    'diag.r4.detail' => '재귀 깊이가 너무 크면 스택 오버플로나 시간이 지수적으로 증가할 수 있습니다',
    'diag.r5.title' => '%s 메모리 피크 %s, 전체의 %s',
    'diag.r5.detail' => '메모리 피크가 한 함수에 집중되어 있습니다 — 해당 함수의 데이터 구조를 먼저 확인하십시오',
    'diag.r6.title' => '%s 자체 소요 시간 %s이(가) 총 소요 시간 %s보다 %s만큼 큽니다',
    'diag.r6.detail' => '자체 소요 시간은 총 소요 시간을 초과해서는 안 됩니다 — 샘플링된 데이터나 통계 계산에 문제가 있을 수 있습니다',
