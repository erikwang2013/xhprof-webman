...
return [
    ...
    'diag.r4.title' => 'Recursion detected in %s(), maximum depth %d',
    'diag.r4.detail' => 'Excessive recursion depth can cause a stack overflow or exponentially growing time',
