...
return [
    ...
    'diag.title' => 'نتائج التشخيص',
    'diag.whySlow' => 'لماذا هو بطيء',
    'diag.otherFindings' => 'ملاحظات أخرى',
    'diag.view' => 'عرض',
    'diag.empty' => 'لم يُعثر على عنق زجاجة واضح (العتبات: الزمن الذاتي ≥ %s%%، عدد الاستدعاءات ≥ %s، استدعاءات الحواف ≥ %s، الزمن الذاتي للدالة المُستدعاة ≥ %s%%، ذروة الذاكرة ≥ %s%%)',
    'diag.r1.title' => '%s: الزمن الذاتي %s، وهو %s من هذا الطلب',
    'diag.r1.detail' => 'الزمن الذاتي لا يشمل الاستدعاءات الابنة، فهو زمن جسم الدالة وحده',
    'diag.r2.title' => '%s استُدعيت %s مرة',
    'diag.r2.detail' => 'عدد الاستدعاءات مرتفع، ويجدر التأكد من كونه متوقّعًا',
    'diag.r3.title' => '%s → %s استُدعيت %s مرة، بإجمالي %s',
    'diag.r3.detail' => 'علاقة الاستدعاء هذه تمثّل حصة ملحوظة من الزمن',
    'diag.r4.title' => 'تم اكتشاف استدعاء ذاتي في %s()، بأقصى عمق %d',
    'diag.r4.detail' => 'قد يؤدي العمق المفرط للاستدعاء الذاتي إلى تجاوز سعة المكدس أو نمو الوقت بشكل أسي',
    'diag.r5.title' => '%s: ذروة الذاكرة %s، وهي %s من الإجمالي',
    'diag.r5.detail' => 'ذروة الذاكرة مركّزة في دالة واحدة، يُستحسن فحص بنى بياناتها أولًا',
    'diag.r6.title' => '%s: الزمن الذاتي %s يتجاوز الزمن الشامل %s بفارق %s',
    'diag.r6.detail' => 'الزمن الذاتي لا ينبغي أن يتجاوز الزمن الشامل أبدًا، فقد تكون بيانات العيّنات أو الحساب الإحصائي خاطئة',
