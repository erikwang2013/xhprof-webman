 ...
 */
export declare const DEFAULT_EVALUATION_METRIC = "correctness";
/**
 ...
 */
export declare function metricRequiresModelConnection(metric: string): boolean;
//# sourceMappingURL=evaluation-helpers.d.ts.map