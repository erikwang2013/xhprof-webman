...
| Сигнатуры и семантика адаптеров для Webman / Laravel / ThinkPHP / Hyperf | эти четыре не входят в контур верификации (он охватывает шесть фреймворков); их заглушки написаны вручную внутри пакета, в `tests/Stubs/framework-stubs.php`, без сверки с настоящими пакетами |
