...
| अडैप्टर जो मेथड कॉल करते हैं वे सचमुच मौजूद हैं | `tools/contracts/` सत्यापन लूप (उसका अपना CI जॉब): असली फ़्रेमवर्क पैकेज इंस्टॉल करके रिफ़्लेक्शन से जाँचता है कि हर मेथड / कॉन्स्टेंट / ग्लोबल फ़ंक्शन मौजूद है — **लूप में शामिल छह फ़्रेमवर्क** (Slim / Symfony / Yii3 / Joomla / WordPress / Drupal) के लिए; Webman / Laravel / ThinkPHP / Hyperf लूप में नहीं हैं, नीचे देखें |
...
| Webman / Laravel / ThinkPHP / Hyperf के अडैप्टर सिग्नेचर और सिमेंटिक्स | ये चारों सत्यापन लूप में शामिल नहीं हैं (लूप छह फ़्रेमवर्क कवर करता है); इनके स्टब पैकेज के भीतर `tests/Stubs/framework-stubs.php` में हाथ से लिखे गए हैं, असली पैकेजों से कोई तुलना नहीं |
