 ...
 * the read-only diagram originals listed in I18N_DOCS (tools/i18n/lib.php).
 *
 * Not a glob over docs/images/: that directory also holds non-diagram art
 * (pet.svg), which never enters this pipeline.
 *
 ...
 *
 * The diagram originals are never modified.  The templates are byte-for-byte copies
 ...
 *
 * The diagram originals are read-only, so a defect in the original layout cannot be
...
$manifest = [
    '_readme' => 'Generated by tools/i18n/extract.php from the diagram originals in docs/images/ '
        . 'listed in I18N_DOCS (tools/i18n/lib.php). '
